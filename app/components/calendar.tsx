...
const Calendar = () => {
  ...
  const images: [string, string, string, string] = ["/story-1.jpg", "/story-2.jpg", "/story-3.jpg", "/story-4.jpg"];
    ...
    <div ref={containerRef} className="relative w-full h-full overflow-x-auto [&::-webkit-scrollbar]:hidden">
      <div className="absolute h-full left-0 py-4 px-1 flex">
        <section className="w-72 h-full">
          ...
          <article className="w-full h-full p-1 border-r grid grid-cols-1 grid-rows-6 gap-2">
